...
public class ManageInstructorWithDeleteView extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.manage_instructor_menu, menu);
        return true;
    }
    ...
    public void showDeleteDialog() {
        DeleteInstructorDialog deleteDialog = new DeleteInstructorDialog(instructorId, name.getText().toString(), repo, this);
